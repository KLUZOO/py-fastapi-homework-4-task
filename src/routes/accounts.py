...
BASE_URL_ACCOUNTS = "http://127.0.0.1:8000/api/v1/accounts"
LOGIN_LINK = f"{BASE_URL_ACCOUNTS}/login/"
RESET_LINK = f"{BASE_URL_ACCOUNTS}/reset-password/complete/"
...
async def register_user(
    ...
    Args:
        ...
        email_sender (EmailSenderInterface): The email sender object.
